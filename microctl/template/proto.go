...
option go_package = "{{.Domain}}/{{.Project}}/{{.Service}}/server/proto/{{.Service}}";
...
`
	...
	dir := "./" + data.Domain + "/" + data.Project + "/" + data.Service + "/server/proto/" + data.Service + "/"
...
`
	...
	dir = "./" + data.Domain + "/" + data.Project + "/" + data.Service + "/server/proto/google/api/"
...
`
	...
	dir = "./" + data.Domain + "/" + data.Project + "/" + data.Service + "/server/proto/google/rpc/"
